...
| 6c-2 | 템플릿으로 행 만들기 — 고른 템플릿을 복제해 새 행을 만듭니다(속성 값 + 본문 + 하위 페이지) | ⬜ |
| 6c-3 | 화면 — `New ▾` 목록 · 템플릿 편집 · 기본 템플릿 지정 | ⬜ |

**숫자** — 마이그레이션 26개 · 테이블 50개 · 테스트 1,915개(DB 포함, CI 에서 skip 0) + 실제 브라우저 검증 376개 · PR 111개 머지.
