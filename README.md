...
다음은 **relation · rollup** 입니다.

**숫자** — 마이그레이션 23개 · 테이블 50개 · 테스트 1,772개(DB 포함, CI 에서 skip 0) + 실제 브라우저 검증 314개 · PR 101개 머지.
...
db/migrations/                 raw SQL 23개. ORM 없음
...
src/lib/
  ...
  database/                      프로퍼티 · 셀 · 필터 컴파일러 · 뷰 · 그룹(보드) · 드래그 규칙
  file/                          업로드 · 스토리지 드라이버
