...
다음은 **Teamspace · 게스트 · 그룹**입니다 — 권한 코어 위의 확장이고, 주체축 권한 캐시 무효화(`perm_gen`)가 여기서 실전에 들어갑니다.

**숫자** — 마이그레이션 26개 · 테이블 50개 · 테스트 1,935개(DB 포함, CI 에서 skip 0) + 실제 브라우저 검증 403개 · PR 114개 머지.
