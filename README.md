...
| 2 | 편집 로그 저장소(`doc_update`) | 진행 예정 |
| 3–6 | 연쇄 삭제 막기 · 서버 명령 경로와 프로젝터 · 협업 서버 · 에디터 바인딩 | |

그다음은 코멘트와 멘션 · Board · relation · 템플릿입니다.

**숫자** — 마이그레이션 15개 · 테이블 39개 · 테스트 1,502개(DB 포함, CI 에서 skip 0) + 실제 브라우저 검증 206개 · PR 65개 머지.
...
src/lib/
  ...
  collab/                        Y.Doc 본문 계약 · 동시 편집 정규화 (Phase 1)
